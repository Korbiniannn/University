...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        range_counter = 0
        #old code for problem 3 and problem 4(wasn´t really good had to make a while loop for every case)
        '''
        if current_place.is_hive == True:
            return None
        
        elif self.min_range and self.max_range:
            while range_counter != self.min_range and range_counter != self.max_range or current_place.bees == []:
                if current_place.is_hive == True:
                    return None
                current_place = current_place.entrance
                range_counter += 1
            return random_bee(current_place.bees) if current_place.is_hive == False else None
        
        elif self.min_range:
            while range_counter < self.min_range or current_place.bees == []:
                if current_place.is_hive == True:
                    return None
                current_place = current_place.entrance
                range_counter += 1
            ...
            while current_place.bees == []:
                ...
                current_place = current_place.entrance
                range_counter += 1
            return random_bee(current_place.bees) if range_counter <= self.max_range and current_place.is_hive == False else None
        ...
        # END Problem 3 and 4
        '''
        # new and better code for problem 3 and problem 4
        while range_counter < self.min_range or len(current_place.bees) == 0:
            if current_place.is_hive == True:
                return None
            current_place = current_place.entrance
            range_counter += 1
        return random_bee(current_place.bees) if range_counter >= self.min_range and range_counter <= self.max_range else None
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        for bee in bees_copy:
            bee.reduce_health(self.damage + amount) if self.health - amount <= 0 else bee.reduce_health(amount)
